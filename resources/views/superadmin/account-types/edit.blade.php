    ...
    <form action="{{ route('superadmin.account-types.update', $accountType) }}" method="POST">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" name="min_balance" class="form-control @error('min_balance') is-invalid @enderror" value="{{ old('min_balance', $accountType->min_balance) }}">
            ...
            <div class="form-group">
                ...
                <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="2">{{ old('description', $accountType->description) }}</textarea>
