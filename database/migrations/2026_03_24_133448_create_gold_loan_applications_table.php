...
return new class extends Migration
{
    ...
    {
        Schema::create('gold_loan_applications', function (Blueprint $table) {
            $table->id();
            $table->foreignId('customer_id')->constrained('customers')->onDelete('restrict');
            $table->foreignId('loan_type_id')->constrained('gold_loan_types')->onDelete('restrict');
            ...
            $table->decimal('ornament_weight', 10, 3)->nullable(); // grams
            $table->decimal('gold_karat', 5, 2)->nullable();
            $table->boolean('gold_purity_verified')->default(false);
            $table->decimal('customer_income', 15, 2)->nullable();
            $table->boolean('bill_verified')->default(false);
            $table->longText('ornament_photo')->nullable();
    ...
    {
        Schema::dropIfExists('gold_loan_applications');
    }
};
